...
namespace VirtoCommerce.Storefront.AutoRestClients.CustomerReviewsModuleApi
{
    ...
    public partial class CustomerReviewsWebRESTAPIdocumentation : ServiceClient<CustomerReviewsWebRESTAPIdocumentation>, ICustomerReviewsWebRESTAPIdocumentation
    {
        ...
        private void Initialize()
        {
            ...
            BaseUri = new System.Uri("http://localhost:1451");
...
namespace VirtoCommerce.Storefront.AutoRestClients.CustomerReviewsModuleApi
{
    ...
    public partial class CustomerReviews : IServiceOperations<CustomerReviewsWebRESTAPIdocumentation>, ICustomerReviews
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<GenericSearchResultCustomerReview>> GetByIdsWithHttpMessagesAsync(IList<string> ids, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (ids == null)
            {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse> ApproveWithHttpMessagesAsync(CustomerReviewIdModel review, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (review == null)
            {
            ...
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/customerReviews/approve").ToString();
            // Create HTTP transport objects
            var _httpRequest = new HttpRequestMessage();
            HttpResponseMessage _httpResponse = null;
            _httpRequest.Method = new HttpMethod("POST");
            ...
            if (review != null)
            {
                _requestContent = SafeJsonConvert.SerializeObject(review, Client.SerializationSettings);
                _httpRequest.Content = new StringContent(_requestContent, System.Text.Encoding.UTF8);
                _httpRequest.Content.Headers.ContentType = System.Net.Http.Headers.MediaTypeHeaderValue.Parse("application/json; charset=utf-8");
            }
            // Set Credentials
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse> RejectWithHttpMessagesAsync(CustomerReviewIdModel review, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (review == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "review");
            ...
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/customerReviews/reject").ToString();
            // Create HTTP transport objects
            var _httpRequest = new HttpRequestMessage();
            HttpResponseMessage _httpResponse = null;
            _httpRequest.Method = new HttpMethod("POST");
...
namespace VirtoCommerce.Storefront.AutoRestClients.CustomerReviewsModuleApi
{
    ...
    public partial interface ICustomerReviews
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse<GenericSearchResultCustomerReview>> GetByIdsWithHttpMessagesAsync(IList<string> ids, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <param name='customerReviews'>
        /// </param>
        /// <param name='customHeaders'>
        /// The headers that will be added to request.
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse> ApproveWithHttpMessagesAsync(CustomerReviewIdModel review, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <param name='review'>
        /// </param>
        /// <param name='customHeaders'>
        /// The headers that will be added to request.
...
namespace VirtoCommerce.Storefront.AutoRestClients.CustomerReviewsModuleApi
{
    ...
    public static partial class CustomerReviewsExtensions
    {
        ...
        /// <param name='ids'>
        /// </param>
        public static GenericSearchResultCustomerReview GetByIds(this ICustomerReviews operations, IList<string> ids)
        {
        ...
        /// The cancellation token.
        /// </param>
        public static async Task<GenericSearchResultCustomerReview> GetByIdsAsync(this ICustomerReviews operations, IList<string> ids, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name='productId'>
        /// </param>
        public static ProductRating GetProductRating(this ICustomerReviews operations, string productId)
        {
        ...
        /// The cancellation token.
        /// </param>
        public static async Task<ProductRating> GetProductRatingAsync(this ICustomerReviews operations, string productId, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name='review'>
        /// </param>
        public static void Approve(this ICustomerReviews operations, CustomerReviewIdModel review)
        {
            operations.ApproveAsync(review).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async Task ApproveAsync(this ICustomerReviews operations, CustomerReviewIdModel review, CancellationToken cancellationToken = default(CancellationToken))
        {
            (await operations.ApproveWithHttpMessagesAsync(review, null, cancellationToken).ConfigureAwait(false)).Dispose();
        }
        ...
        /// <param name='review'>
        /// </param>
        public static void Reject(this ICustomerReviews operations, CustomerReviewIdModel review)
        {
            operations.RejectAsync(review).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async Task RejectAsync(this ICustomerReviews operations, CustomerReviewIdModel review, CancellationToken cancellationToken = default(CancellationToken))
        {
            (await operations.RejectWithHttpMessagesAsync(review, null, cancellationToken).ConfigureAwait(false)).Dispose();
        }
...
namespace VirtoCommerce.Storefront.AutoRestClients.CustomerReviewsModuleApi.Models
{
    ...
    public partial class CustomerReviewIdModel
    {
        /// <summary>
        /// Initializes a new instance of the CustomerReviewIdModel class.
        /// </summary>
        public CustomerReviewIdModel()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the CustomerReviewIdModel class.
        /// </summary>
        public CustomerReviewIdModel(string id = default(string))
        {
            Id = id;
            CustomInit();
        }
